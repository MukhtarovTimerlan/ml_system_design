...
- Логи запросов  
- Cбор пользовательской обратной связи (реакции, переходы) и пилот с анализом релевантности выводимых дайджестов.  
...
- релевантность контекстов (ручная аннотация,Recall@k),
- компактность ответа (коэффициент сжатия, кол-во токенов),
- устойчивость модели к галлюцинациям (ручная экспертиза, attribution score).

---

## 6. Блок-схема решения
<img width="1583" height="463" alt="solution_stages" src="https://github.com/user-attachments/assets/7124aa31-139b-469d-af1c-44024ae9e803" />
